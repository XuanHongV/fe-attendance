      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
        <div className="md:hidden bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm flex-shrink-0 z-20">
            <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-gray-800 text-lg">Payroll System</span>
            </div>
        </div>
  ...
  return (
    <>
      ...
      <Route element={<PrivateLayout />}>
        ...
        <Route path="/staff" element={<Navigate to="/staff/shift" replace />} />
        <Route path="/settings" element={<div className="p-6 text-gray-500">Trang Cài đặt đang được xây dựng...</div>} />
      </Route>
      <Route path="*" element={
        <div className="flex flex-col items-center justify-center h-screen bg-gray-50 text-gray-500">
            <h1 className="text-4xl font-bold mb-2">404</h1>
            <p>Trang không tồn tại</p>
            <a href="/" className="mt-4 text-blue-600 hover:underline">Quay về trang chủ</a>
        </div>
      } />
    </Routes>
    </>
