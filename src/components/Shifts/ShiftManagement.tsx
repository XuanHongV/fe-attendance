        ...
        <div className='p-4 md:p-8 bg-[#F8FAFC] min-h-screen font-sans'>
            <div className='mb-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                <div>
                    ...
                    <p className='text-slate-500 font-medium mt-1 uppercase text-[10px] tracking-[0.2em] opacity-70'>
                        Shift Management System v2.0
                    </p>
                </div>
                <button
                    onClick={() => handleOpenModal()}
                    className='bg-blue-600 text-white px-8 py-4 rounded-[1.5rem] hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 font-black text-xs uppercase tracking-widest active:scale-95'
                >
                        ...
                        >
                            ...
                            <div className='flex justify-between items-start mb-6'>
                                <div className='flex items-center gap-4 min-w-0'>
                                    <div
                                        className='w-14 h-14 rounded-3xl flex items-center justify-center text-white font-black shadow-lg shrink-0'
                                        style={{ backgroundColor: shift.color_code }}
                                    >
                                    ...
                                    <button
                                        onClick={() => {
                                            if (window.confirm('Xóa ca này?'))
                                                api.delete(`/shifts/${shift._id}`).then(
                                                    () => fetchData()
                                                );
                                        }}
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                ...
                                <div className='bg-slate-50 p-4 rounded-2xl text-center'>
                                    ...
                                    <p className='text-sm font-black text-green-600'>
                                        {(shift.allowance || 0).toLocaleString()}đ
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='p-8 border-b border-slate-50 flex justify-between items-center bg-white shrink-0'>
                            <div>
                                <h3 className='text-2xl font-black text-slate-900 tracking-tight'>
                                    {editingId ? 'Chỉnh Sửa Ca' : 'Cấu Hình Ca Mới'}
                                </h3>
                                <p className='text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1'>
                                    Trạng thái: {editingId ? 'Cập nhật' : 'Khởi tạo'}
                                </p>
                            </div>
                            <button
                        ...
                        >
                                ...
                                <div className='space-y-6'>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className='w-full px-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl focus:border-blue-500 focus:bg-white outline-none transition-all font-black text-slate-700'
                                    ...
                                    <div>
                                        ...
                                        <div className='relative'>
                                            <select
                                                ...
                                                className='w-full px-6 py-4 bg-slate-50 rounded-2xl font-black text-slate-700 outline-none border-2 border-transparent focus:border-blue-500 appearance-none transition-all'
                                            >
                                                <option value=''>
                                                    -- Tất cả vị trí --
                                                </option>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className='w-full px-6 py-4 bg-slate-50 rounded-2xl font-black text-green-600 border-2 border-transparent focus:border-green-500 outline-none transition-all'
                                        />
                                    </div>
                                </div>
                                ...
                                <div className='space-y-6'>
                                    ...
                                    <div className='grid grid-cols-2 gap-4'>
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className='w-full px-4 py-4 bg-slate-50 rounded-2xl font-black text-center outline-none border-2 border-transparent focus:border-blue-500'
                                            />
                                        </div>
                                        <div>
                                            <label className='block text-[10px] font-black text-slate-400 uppercase mb-2'>
                                    ...
                                    <div className='p-4 bg-blue-50 border border-blue-100 rounded-2xl flex justify-between items-center'>
                                        ...
                                        <span className='text-sm font-black text-blue-700'>
                                            {formData.standard_working_hours} h
                                        </span>
                                    </div>
                                    <div className='grid grid-cols-2 gap-4'>
                                        <div>
                                            ...
                                            <input
                                                type='number'
                                                value={formData.check_allowed_time}
                                                onChange={(e) =>
                                                    setFormData({
                                                        ...formData,
                                                        check_allowed_time: Number(
                                                ...
                                                className='w-full px-4 py-4 bg-slate-50 rounded-2xl font-black'
                                            />
                                        </div>
                                        <div>
                                            <label className='block text-[10px] font-black text-slate-400 uppercase mb-2'>
                                            ...
                                            <input
                                                ...
                                                className='w-full h-[58px] p-2 bg-slate-50 rounded-2xl cursor-pointer'
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='pt-6 flex flex-col md:flex-row gap-4 border-t border-slate-50 bg-white'>
                                <button
                                    type='button'
                                    onClick={() => setIsModalOpen(false)}
                                    className='flex-1 py-5 bg-slate-100 text-slate-600 rounded-[1.5rem] font-black hover:bg-slate-200 transition-all uppercase tracking-[0.2em] text-[10px]'
                                >
                                    Hủy bỏ
                                </button>
                                <button
                                    ...
                                    className='flex-1 py-5 bg-blue-600 text-white rounded-[1.5rem] font-black hover:bg-blue-700 shadow-xl shadow-blue-100 disabled:opacity-50 flex justify-center items-center gap-2 uppercase tracking-[0.2em] text-[10px]'
                                >
                                    {isSubmitting && (
