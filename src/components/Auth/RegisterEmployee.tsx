      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 overflow-y-auto">
        <div className="w-full max-w-lg space-y-6 bg-white p-8 rounded-2xl shadow-xl my-4">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-blue-700">Đăng ký Nhân viên</h2>
            <p className="mt-2 text-sm text-gray-600">Nhập mã doanh nghiệp để gia nhập.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input 
                  ...
                  placeholder="09xx..." 
                />
                <p className="text-xs text-gray-400 mt-1">(Chưa lưu vào DB)</p>
              </div>
            </div>
            ...
            <div className="text-center mt-4 space-y-2">
               ...
               <p className="text-sm text-gray-500">
                 Mở công ty mới? <Link to="/register" className="font-medium text-gray-700 hover:underline">Đăng ký Doanh nghiệp</Link>
               </p>
            </div>
          </form>
        </div>
